...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(SlavStore.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(SlavStore.App_Start.NinjectWebCommon), "Stop")]

namespace SlavStore.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IStoresService>().To<StoresService>();
